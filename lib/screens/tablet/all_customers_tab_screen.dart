...
import 'package:crm_app/screens/tablet/customer_info_tab_screen.dart';
...
class AllCustomersTabScreen extends StatefulWidget {
  const AllCustomersTabScreen({super.key});

  @override
  State<AllCustomersTabScreen> createState() => _AllCustomersTabScreenState();
}

class _AllCustomersTabScreenState extends State<AllCustomersTabScreen> {
...
class UserCardTAb extends StatefulWidget {
  ...
  @override
  State<UserCardTAb> createState() => _UserCardTAbState();
}

class _UserCardTAbState extends State<UserCardTAb> {
  @override
  Widget build(BuildContext context) {
