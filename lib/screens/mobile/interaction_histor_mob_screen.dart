...
class InteractionHistoryMobScreen extends StatefulWidget {
  const InteractionHistoryMobScreen({super.key});

  @override
  State<InteractionHistoryMobScreen> createState() =>
      _InteractionHistoryMobScreenState();
}

class _InteractionHistoryMobScreenState
    extends State<InteractionHistoryMobScreen> {
